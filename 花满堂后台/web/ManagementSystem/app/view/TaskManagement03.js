(function () {
    Ext.define('ManagementSystem.view.TaskManagement03', {
        extend: 'Ext.grid.Panel',
        xtype: 'taskManagement03',
        id: 'taskManagementId03',
        ...
        columns: [
            ...
            },
            {
                ...
                renderer: function (value, cellmeta, record, rowIndex, columnIndex, store) {
                    var str = "";
                    str = "<a href='#' id='TaskDetailWin03'>详情</a>";
                    return str;
                }
            },
            {
                ...
                renderer: function (value, cellmeta, record, rowIndex, columnIndex, store) {
                    ...
                    if (record.get("taskstatus") == 1) {
                        if (record.get("paymethod") == 0) {
                            str = "<input type='button' value='打印订单' id='PrintTaskDetail03' style='cursor: pointer'/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" +
                            "<input type='button' value='取消订单' id='CancelTaskDetail03' style='cursor: pointer'/>";
                        }else{
                            str = "<input type='button' value='打印订单' id='PrintTaskDetail03' style='cursor: pointer'/>";
                        }
                ...
                items: [
                    {
                        ...
                        html: '<div style="margin-left: 15px;font-size: 20px;font-weight: bold" id="">食杂铺订单</div>'
                    }
                ]
            },
            {
            ...
            },
            {
                ...
                items: [
                    ...
                    ,
                    {
                        ...
                        border: false,
                        bodyStyle: 'background-color: #eeeeee;background-image: url();',
                        html: '<div style="color: red;margin-left: 10px;width:100%;">当前页面还剩<span id="DaoJiShi03" style="font-weight: bolder;margin:0 5px;">30</span>秒将进行刷新！</div>'
                    }
                ]
            },
            {
                ...
                items: [
                    {
                        ...
                        items: [
                            ...
                            {boxLabel: "派送中", name: "3", id: 'TaskStatus04', itemId: 'TaskStatus04'},
