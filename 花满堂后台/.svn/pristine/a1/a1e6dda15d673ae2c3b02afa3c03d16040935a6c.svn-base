 ...
 * 所有菜谱
 */
Ext.define('ManagementSystem.store.AllmenuStore2', {
    ...
    fields: [
        ...
        'dishdescription', 'menusequence', 'menuformat', 'menudetailurl',
        'menuclassname', 'dish_fk', 'depart_fk', 'scoville',

        'menucount', 'menucount2', 'dishid'
    ],
//    proxy: {
//        type: 'ajax',
